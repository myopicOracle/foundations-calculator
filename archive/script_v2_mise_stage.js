...
button4.addEventListener("click", console.log("4"))
button5.addEventListener("click", console.log("5"))
button6.addEventListener("click", console.log("6"))
button7.addEventListener("click", console.log("7"))
button8.addEventListener("click", console.log("8"))
button9.addEventListener("click", console.log("9"))
button0.addEventListener("click", console.log("0"))

buttonAdd.addEventListener("click",console.log("add"))
buttonSubtract.addEventListener("click",console.log("subtract"))
buttonMultiply.addEventListener("click",console.log("multiply"))
buttonDivide.addEventListener("click",console.log("divide"))