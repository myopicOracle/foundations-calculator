...
calculateButton.addEventListener("click", (e) => {
    finalResult.innerHTML = calculateResult(num1, num2, operator);
});
...
// below function works, but changes the "calculate" button content
calculateButton.addEventListener("click", (e) => {
    e.target.innerHTML = calculateResult(num1, num2, operator);
});
